...
<div class="module-card__links">
  <a href="https://geometrics-explore.streamlit.app/" target="_blank" rel="noopener">🚀 Launch app</a>
...
```{=html}
<div class="module-card__links">
  <a href="https://geometrics-analyze.streamlit.app/" target="_blank" rel="noopener">🚀 Launch app</a>
...
```{=html}
<div class="module-card__links">
  <a href="https://geometrics-learn.streamlit.app/" target="_blank" rel="noopener">🚀 Launch app</a>
...
No install, no code — the three geometrics apps run the whole workflow in your
browser on the bundled India and Bolivia case studies: pick a dataset, set the
spatial weights, and every figure arrives with its plain-language reading. Each is
the no-code companion to a docs case study.

```{=html}
<div class="app-row">
  <a class="xpd-btn xpd-btn--app" href="https://geometrics-explore.streamlit.app/" target="_blank" rel="noopener">🗺️ Explore app</a>
  <a class="xpd-btn xpd-btn--app" href="https://geometrics-analyze.streamlit.app/" target="_blank" rel="noopener">🧮 Analyze app</a>
  <a class="xpd-btn xpd-btn--app" href="https://geometrics-learn.streamlit.app/" target="_blank" rel="noopener">📚 Learn app</a>
</div>
```
